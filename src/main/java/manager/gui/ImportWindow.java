...
public class ImportWindow extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        buttonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(buttonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelImport, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        buttonPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, buttonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelImport, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        masterTagsTree.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
    ...
    private void chooseFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseFileButtonActionPerformed
        ...
        if (fileToAdd!=null) pathField.setText(fileToAdd.toString());
        else pathField.setText(null);
    }//GEN-LAST:event_chooseFileButtonActionPerformed

    private void masterTagsTreeValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_masterTagsTreeValueChanged
        masterTagToAdd = (MasterTag)masterTagsTree.getLastSelectedPathComponent();
        if (masterTagToAdd!=null) tagsField.setText(masterTagToAdd.toString());
        else tagsField.setText(null);
