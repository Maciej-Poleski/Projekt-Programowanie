...
public class BackupWindow extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		javax.swing.GroupLayout buttonPanel1Layout = new javax.swing.GroupLayout(
				buttonPanel1);
				...
				.addGroup(
						buttonPanel1Layout
								...
								.addContainerGap(
										...
										Short.MAX_VALUE)));
		buttonPanel1Layout
				.setVerticalGroup(buttonPanel1Layout.createParallelGroup(
						...
						buttonPanel1Layout
								...
								.addComponent(jLabel1,
										javax.swing.GroupLayout.DEFAULT_SIZE,
										23, Short.MAX_VALUE).addContainerGap()));
		...
		backupsList.setCursor(new java.awt.Cursor(
	...
	private void newBackupButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_newBackupButtonActionPerformed
		...
		{
			JOptionPane.showMessageDialog(this, "No MasterTag choosen",
					"Error", JOptionPane.ERROR_MESSAGE);
		} catch (NullPointerException exp3) // sprawdzic dlaczego
		{
			JOptionPane.showMessageDialog(this, "Error NPE", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
		try {
			data.save();
		} catch (IOException ex) {
			Logger.getLogger(BackupWindow.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}// GEN-LAST:event_newBackupButtonActionPerformed

	private void picassaBackupButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_picassaBackupButtonActionPerformed
		try {
			PicassaLoginWindow picasawindow = new PicassaLoginWindow(
					this.backupsmanager
							.getBackupManagerAssociatedWithMasterTag(this.selectedMasterTag),
					data);
	...
	private static class backupListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			window.selectedSecondaryBackup = (SecondaryBackup) window.backupsList
					.getSelectedValue();
		}
	}
	...
	private static class listListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			BackupManager b;
			window.selectedMasterTag = (MasterTag) window.mastertagsList
					.getSelectedValue();
			b = window.backupsmanager
					.getBackupManagerAssociatedWithMasterTag(window.selectedMasterTag);
			try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(BackupWindow.class.getName())
