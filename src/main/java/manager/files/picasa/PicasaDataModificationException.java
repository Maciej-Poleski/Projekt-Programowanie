...
public class PicasaDataModificationException extends Exception {
	 ...
	 */
	public PicasaDataModificationException(String message) {
		super(message);
	}
	 ...
	 */
	public PicasaDataModificationException(Throwable cause) {
		super(cause);
	}
	 ...
	 * 
	 */
	public PicasaDataModificationException(String message, Throwable cause) {
		super(message, cause);
	}
