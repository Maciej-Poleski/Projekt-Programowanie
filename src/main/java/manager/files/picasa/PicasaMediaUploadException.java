...
public class PicasaMediaUploadException extends Exception {
	 ...
	 */
	public PicasaMediaUploadException(String message) {
		super(message);
	}
	 ...
	 */
	public PicasaMediaUploadException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            indicates that the cause is nonexistent or unknown.)
	 */
	public PicasaMediaUploadException(String message, Throwable cause) {
		super(message, cause);
	}
