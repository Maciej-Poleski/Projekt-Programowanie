...
public class PicasaMediaDownloadException extends Exception {
	 ...
	 */
	public PicasaMediaDownloadException() {
		super();
	}
	 ...
	 */
	public PicasaMediaDownloadException(String message) {
		super(message);
	}
	...
	public PicasaMediaDownloadException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            indicates that the cause is nonexistent or unknown.)
	 */
	public PicasaMediaDownloadException(String message, Throwable cause) {
		super(message, cause);
	}
