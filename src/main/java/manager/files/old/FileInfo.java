...
public class FileInfo {
	...
	/**
	 * Pozyskanie sciezki do pliku w oryginalnym katalogu Jesli podany plik nie
	 * istnieje funkcja zwraca null.
	 * 
	 * @param ID
	 *            pliku
	 ...
	 * 
	 * @param ID
	 *            danego pliku i sciezka do niego w backupie
	 * @throws IOException
	 */
	 ...
	 * zwiazanej z backupem
	 * 
	 * @param ID
	 *            danego pliku i sciezka z backupu przeznaczona do usuniecia
	 * @throws IOException
	 */
	...
	/**
	 * Pozyskanie wszystkich posiadanych sciezek do pliku w backupach, zwraca
	 * null, gdy zadna nie istnieje
	 * 
	 * @param ID
	 *            danego pliku
	...
	/**
	 * Pozyskanie wszystkich posiadanych sciezek do plikow w backupach
	 * okreslonych przez kolekcje
	 * 
	 * @param Kolekcja
	 *            ID plikow
	 * @return Mapa w ktorej kluczami sa ID plikow a wartosciami zbioru sciezek
	 *         z nimi zwiazanymi
	 */
	public static HashMap<FileID, Set<File>> getAllPaths(
			Collection<FileID> files) {
	 ...
	 * @throws IOException
	 */
	public static void removeFileInfo(Collection<FileID> files)
			throws IOException {
		Iterator<FileID> iterator = files.iterator();
		FileID file;
		while (iterator.hasNext()) {
