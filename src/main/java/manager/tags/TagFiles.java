 ...
 * 
 * @param <T>
 *            Typ tagu obsługiwanego przez instancję tej klasy
...
class TagFiles<T extends Tag<T>> implements Serializable {
	 ...
	 * 
	 * @param tag
	 *            Tag który posiadają pliki zarządzane przez tą strukturę
	 */
	 ...
	 * 
	 * @param file
	 *            Plik który zostanie oznaczony tym tagiem
	 */
